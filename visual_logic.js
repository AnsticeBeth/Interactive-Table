...
registerOnClick('sphere_black', false, false, [0,1,2], function() {
  assignMat('Office Table Desk', 'paint_black');
}, function() {});

registerOnClick('sphere_chrome', false, false, [0,1,2], function() {
  assignMat('Office Table Desk', 'chrome');
}, function() {});

registerOnClick('sphere_white', false, false, [0,1,2], function() {
  assignMat('Office Table Desk', 'Sphere_material');
}, function() {});
...
registerOnClick('slab03', false, false, [0,1,2], function() {
  replaceTexture('woodMaterial0', 'wood', 'Wood023_2K_Color.png', function() {});
}, function() {});

registerOnClick('Drawer.001', false, false, [0,1,2], function() {
  if (status2 == 'closed') {

    operateAnimation('PLAY', 'Drawer.001', 1, 30, 'LoopOnce', 2,
            function() {
      status2 = 'open';
    }, false);
...
registerOnClick('Drawer.002', false, false, [0,1,2], function() {
  if (status2 == 'closed') {

    operateAnimation('PLAY', 'Drawer.002', 1, 30, 'LoopOnce', 2,
            function() {
      status2 = 'open';
    }, false);
...
registerOnClick('Drawer.003', false, false, [0,1,2], function() {
  if (status2 == 'closed') {

    operateAnimation('PLAY', 'Drawer.003', 1, 30, 'LoopOnce', 2,
            function() {
      status2 = 'open';
    }, false);
...
registerOnClick('Cabinet_door', false, false, [0,1,2], function() {
  if (status2 == 'closed') {

    operateAnimation('PLAY', 'Cabinet_door', 1, 30, 'LoopOnce', 2,
            function() {
      status2 = 'open';
    }, false);
